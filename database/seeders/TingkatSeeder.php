...
class TingkatSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Tingkat::create(['code' => 7, 'is_active' => false, 'name' => 'tujuh', 'romawi' => 'VII', 'tipe' => 'SMP']);
        Tingkat::create(['code' => 8, 'is_active' => false, 'name' => 'delapan', 'romawi' => 'VIII', 'tipe' => 'SMP']);
        Tingkat::create(['code' => 9, 'is_active' => false, 'name' => 'sembilan', 'romawi' => 'IX', 'tipe' => 'SMP']);
        Tingkat::create(['code' => 10, 'is_active' => true,  'name' => 'sepuluh', 'romawi' => 'X', 'tipe' => 'SMA']);
        Tingkat::create(['code' => 11, 'is_active' => true,  'name' => 'sebelas', 'romawi' => 'XI', 'tipe' => 'SMA']);
        Tingkat::create(['code' => 12, 'is_active' => true,  'name' => 'duabelas', 'romawi' => 'XII', 'tipe' => 'SMA']);
    }
}
