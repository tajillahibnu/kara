...
mainTable = () => {
    APP.initTable({
        ...
        buttons: [{
            text: '<i class="fa fa-plus ti-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Jurusan</span>',
                ...
                render: function (data, type, full, meta) {
                    ...
                    <div class="d-flex justify-content-left align-items-center">
                        <div class="d-flex flex-column">
                            <h6 class="text-truncate mb-0">${full['kode']}</h6>
                            <small class="text-truncate">${full['name']}</small>
                        </div>
                    </div>
                    `
                },
